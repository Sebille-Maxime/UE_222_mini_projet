 ...
 */
final class Version20230129152436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD COLUMN titre VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE article ADD COLUMN texte CLOB NOT NULL');
    }
